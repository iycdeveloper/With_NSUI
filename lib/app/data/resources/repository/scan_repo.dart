...
class ScanRepo {
  ...
  scan(String barcode, String lat, String long) async {
    var scanData = '''
    [{"V":"${AppConstants.iycVersion}","ORG":"${AppConstants.orgName}",
    ...
    ''';
    try {
      var base64encoded = base64.encode(utf8.encode(scanData));
      Response result = await dioClient.post(Urls.scan,
          options: Options(
