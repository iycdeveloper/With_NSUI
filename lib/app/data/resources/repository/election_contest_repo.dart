...
import 'package:iyc/app/data/resources/remote/exception/api_error_handler.dart';import 'package:iyc/app/data/resources/services/local_storage_services.dart';import 'package:iyc/app/data/resources/urls.dart';
import 'package:iyc/utils/app_constants.dart';
import 'package:iyc/utils/utils.dart';

class ElectionContestRepo {
  DioClient dioClient = sl();

  // getElectionContestList() async {
  //   var data =
  ...
  addElectioncontest(Map<String, String> data) async {
    try {
      var base64encoded = base64.encode(utf8.encode('''[${jsonEncode(data)}]'''));
      print("Encode:"+base64encoded);

      Response result = await dioClient.post(Urls.addElectionContest,
          options: Options(
              contentType: Headers.textPlainContentType,
              responseType: ResponseType.plain,
              receiveDataWhenStatusError: true,
  ...
  viewElectionContestData(Map<String, String> chaloPanchayatData) async {
    try {
      var data = '''[${jsonEncode(chaloPanchayatData)}]''';
      var base64encoded = base64.encode(utf8.encode(data));
      Response result = await dioClient.post(Urls.viewElectionContest,
          options: Options(
              contentType: Headers.textPlainContentType,
              responseType: ResponseType.plain,
              receiveDataWhenStatusError: true,
