...
import 'package:iyc/app/modules/live_camera/models/image_data.dart';
import 'package:iyc/app/modules/live_camera/presentation/widgets/custom_camera_preview/custom_camera_preview.dart';
import 'package:iyc/app/modules/live_camera/presentation/widgets/custom_face_detector/worker.dart';

class CustomFaceDetector extends StatefulWidget {
  final ValueChanged<(InputImage, List<Face>)>? onAnalysisData;
  final CustomPaint? customPaint;
  final ValueChanged<CameraController>? onCameraControllerAvailable;
  ...
  const CustomFaceDetector(
      ...
      this.onCameraControllerAvailable});
  @override
...
class _CustomFaceDetectorState extends State<CustomFaceDetector> {
  ...
  Widget build(BuildContext context) {
    return CustomCameraPreview(
      ...
      onCameraControllerAvailable: (controller) {
        setState(() {
          widget.onCameraControllerAvailable!(controller);
        });
      },
    );
  }
