                    ...
                    Container(
                      ...
                      child: Column(
                        children: List.generate(
                          logic.membershipBatchList.length,
                          (index) => InkWell(
                            onTap: () {
                              RoutesManagement.goToMembershipMemberListScreen(
                                  logic.membershipBatchList[index].batchId);
                            },
                            child: Container(
                              padding: const EdgeInsets.symmetric(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 1,
                                    child: Text(
                                      '${logic.membershipBatchList[index].countAM}',
                                      style: const TextStyle(
                                        color: Color(0xFF365B85), // Body color
                                        fontFamily: 'Be Vietnam Pro',
                                        fontSize: 14,
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Text(
                                      logic.membershipBatchList[index]
                                                  .syncStatus! ==
                                              "1"
                                          ? "Completed"
                                          : "Pending",
                                  ...
                                  Expanded(
                                    ...
                                    child: Text(
                                      logic.membershipBatchList[index]
                                          ...
                                          : "Pending",
                                      style: TextStyle(
                                        color: logic.paymentStatusColor(logic
                                            .membershipBatchList[index]
                                            .paymentStatus!), // Orange---Progress color
                                        fontFamily: 'Be Vietnam Pro',
                                        fontSize: 14,
