...
class MembershipMemberViewController extends GetxController {
  ...
  void setCurrentMember(
    ...
    statePresidentController.text =
        "State President  Candidate \nCSN : ${currentMember!.statePresidentCandidate ?? ""}";
    districtPresidentController.text =
        'District President Candidate \nCSN :${currentMember!.districtCandidate ?? ''}';
    universityPresidentController.text =
        'University President Candidate \nCSN :${currentMember!.assemblyCandidate ?? ''}';
    collegePresidentController.text =
        'College President Candidate \nCSN :${currentMember!.mandalamCandidate ?? ''}';

    stateSGSPresidentController.text =
        "State General Secretary Candidate \nCSN : ${currentMember!.stateGSCandidate ?? ""}";
...
//Old functionality below
  ...
  TextEditingController stateSGSPresidentController = TextEditingController();
