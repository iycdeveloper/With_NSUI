...
class MembershipBatchController extends GetxController{
  ...
  List<BatchDataModel> get membershipBatchList => _membershipBatchList.reversed.toList();
  ...
  void updateAMCount({required BuildContext context, required BatchDataModel data}) async {
  ...
  void downloadExistingBatch({required BuildContext context,}) async {
    ProgressDialogUtils.showProgressIndicator();
