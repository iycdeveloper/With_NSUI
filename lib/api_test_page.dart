...
class _ApiTestPageState extends State<ApiTestPage> {
  ...
  @override
  void initState() {
    AuthRepo(dioClient: sl<DioClient>()).getLeaderBoard("ALL");
    super.initState();
  ...
  Future<void> _makePhoneCall(String phoneNumber) async {
    ...
    await toPage(
        ...
        ChangeNotifierProvider(
          ...
          child: const MembersList(batchId: "abcdefgh", syncStatus: false),
        ),
  ...
  Widget build(BuildContext context) {
    ...
    final Uri toLaunch = Uri(scheme: 'https', path: 'twitter.com/iycmadhya/');
    return Scaffold(
      appBar: AppBar(
