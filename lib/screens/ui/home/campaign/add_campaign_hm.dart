...
import 'package:iyc/view_model/campaign/add_campaign_hm_vm.dart';
import 'package:iyc/view_model/campaign/view_campaign_data_vm.dart';
import 'package:pinput/pinput.dart';
import 'package:provider/provider.dart';
import 'package:toggle_switch/toggle_switch.dart';

class AddCampaignHm extends StatefulWidget {
  const AddCampaignHm({Key? key, required this.campaignId, this.langCode})
      : super(key: key);
  final String campaignId;
  final String? langCode;

  @override
  State<AddCampaignHm> createState() => _AddCampaignHmState();
}

class _AddCampaignHmState extends State<AddCampaignHm> {
  ...
  @override
  void initState() {
    context.read<AddCampaignHmVM>().idController.addListener(() => context
        .read<AddCampaignHmVM>()
        .idControllerListner(context.read<AddCampaignHmVM>().idController));

    context.read<AddCampaignHmVM>().initVotersList(context, widget.langCode);
    context.read<AddCampaignHmVM>().mobileFocus.addListener(() {
      bool hasFocus = context.read<AddCampaignHmVM>().mobileFocus.hasFocus;
      if (hasFocus) {
    ...
    context.read<AddCampaignHmVM>().campaignCodeFocus.addListener(() {
      bool hasFocus = context.read<AddCampaignHmVM>().otpCodeFocus.hasFocus;
      if (hasFocus) {
        KeyboardOverlay.showOverlay(context);
      } else {
        KeyboardOverlay.removeOverlay();
    ...
    context.read<AddCampaignHmVM>().refererFocus.addListener(() {
      bool hasFocus = context.read<AddCampaignHmVM>().refererFocus.hasFocus;
      if (hasFocus) {
        KeyboardOverlay.showOverlay(context);
      } else {
        KeyboardOverlay.removeOverlay();
    ...
    context.read<AddCampaignHmVM>().initAddCampaign(
      context,
      widget.campaignId,
    );
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("हिमाचल कांग्रेस संकल्प"),
        centerTitle: true,
        actions: [
          TextButton(
            child: Text(
          ...
          //
          //     if (voter != null)
          //       context.read<AddCampaignHmVM>().updateUserData(voter);
          //   },
          // ),
        ],
      ),
      body: Consumer<AddCampaignHmVM>(
        builder: (context, model, __) {
          if (model.isLoading) return NetworkLoading();
          return CustomScrollView(slivers: [///9317933904
            // SliverToBoxAdapter(
            //   child: Column(
            //     children: [
            //       SizedBox(
            ...
            //                       onSubmitted: (str) {
            //                         context.read<AddCampaignHmVM>().searchVoter(
            //                           context,
            //                           str,
            //                         );
            //                       },
              ...
              child: Column(
                children: [
                  ...
                  DropDownPicker(
                    ...
                    onChanged: (value) {
                      context.read<AddCampaignHmVM>().changeGender(value);
                    },
                    labelText: "लिंग",
                    hintText: "लिंग",
                  ),
                  ...
                  DropDownPicker(
                    ...
                    onChanged: (value) {
                      context.read<AddCampaignHmVM>().changeCategory(value);
                    },
                    labelText: "श्रेणी",
                    hintText: "श्रेणी",
                  ),
              ...
              child: Column(
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                              "हिमाचल कांग्रेस  सरकार द्वारा किए गये 12 काम की जानकारी (हां/नहीं)",
                              style: TextStyle(
                  ...
                  DropDownPicker(
                    ...
                    onChanged: (value) {
                      context.read<AddCampaignHmVM>().changeFamilyVoter(value);
                    },
                  ...
                  DropDownPicker(
                    ...
                    onChanged: (value) {
                      context.read<AddCampaignHmVM>().changeNeedToAddVoter(value);
                    },
                  ...
                  TextFieldWithLabel(
                    ...
                    maxLength: 10,
                    focusNode: context.read<AddCampaignHmVM>().mobileFocus,
                    validation: (value) {
                      if (value.isEmpty) {
                  ...
                  //               context.read<AddCampaignHmVM>().selectParty('कांग्रेस');
                  //             },
                  //           ), //Checkb
                  //           Container(
                  ...
                  //               // context
                  //               //     .read<AddCampaignMpVM>().validateVoterIdAndShowPopUp();
                  //               context.read<AddCampaignHmVM>().selectParty('भाजपा');
                  //             },
                  //           ), //Checkb
                  //           Container(
                  //             width: MediaQuery.of(context).size.width * 0.7,
                  ...
                  //               // context
                  //               //     .read<AddCampaignMpVM>().validateVoterIdAndShowPopUp();
                  //               context.read<AddCampaignHmVM>().selectParty('आम आदमी पार्टी');
                  //             },
                  //           ),
                  //           Container(
                  //             width: MediaQuery.of(context).size.width * 0.7,
                  ...
                  TextFieldWithLabel(
                    ...
                    maxLength: 10,
                    focusNode: context.read<AddCampaignHmVM>().refererFocus,
                    validation: (value) {
                      return null;
                    },
                  ),
                    ...
                    children: [
                      ...
                      Checkbox(
                        ...
                        onChanged: (value) {
                          // context
                          //     .read<AddCampaignMpVM>().validateVoterIdAndShowPopUp();
                          context.read<AddCampaignHmVM>().changeCheckBox(!model.checkBoxTicked);
                        },
                      ), //Checkb
                      Container(
                        width: MediaQuery.of(context).size.width * 0.7,
